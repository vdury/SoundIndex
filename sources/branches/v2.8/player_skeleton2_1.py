...
class MediaPanel(wx.Panel):
    ...
    def drawMark(self, reload):
        ...
        if (((a != 0) | (b != 0)) & reload == 1):
            self.scrollbar.SetThumbPosition((min(self.x0, self.x1)) - 1)
    ...
    def OnScroll(self, event):
        ...
        if self.play >= 0:
            ...
            moment = self.scrollbar.GetThumbPosition()
            #print moment
            #print self.Time[10*self.fs]
            #print self.signal[10*self.fs]
    ...
    def onPlay(self, event):
        ...
        if not self.mediaPlayer.Play():
            ...
            #offset = ((((min(self.x0, self.x1))/1.0)/(self.imageMaxWidth/1.0)) * self.zoom) + self.scrollbar.GetThumbPosition()
    ...
    def secondsToCoords(self, x):
        ...
        if x < a:
            ...
            #print x, a, b, self.imageMaxWidth
